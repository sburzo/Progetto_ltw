...
<!-- fine Navbar -->
    ...
    <section class="contact-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-text">
                        <h2>Contacts</h2>
                        <p>Our Customer Service is available every day, feel free to contact us</p>
                        <table>
                            <tbody>
                                <tr>
                                    <td class="c-o">Address:</td>
                                    <td>Viale dello Scalo S. Lorenzo, 82, Rome</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td>(+39) 366-5439201</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Email:</td>
                                    <td>info.hotels@hotmail.it</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Fax:</td>
                                    <td>(+39) 366-5439201</td>
            ...
            <div class="map">
                <iframe
                    src="https://www.google.com/maps/embed/v1/place?q=Viale+dello+Scalo+S.+Lorenzo,+Roma,+RM,+Italia&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
